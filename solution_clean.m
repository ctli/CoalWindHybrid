...
xlabel('Output power (in-house use excluded)');
ylabel('Coal Consumption (ton/h)');
legend('2 plants@minumum; 1 plants increases', '1 plant@minumum; 2 plants increase equally', 'all three plants increase equally');
set(legend, 'location', 'northwest');
...
% ==========
figure(31); clf;
set(gcf, 'units', 'inch', 'pos', [13.4375    0.7500    3.16*1.75    5.35*1.75]);
