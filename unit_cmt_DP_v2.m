...
J_star         = nan*ones(coal_num, length(wind_pwr)); % [x]x[t]; Cummulative cost
...
f_dispatch     = -1*ones(coal_num, coal_num, length(wind_pwr));% [14 units]x[x]x[t];
